...
public final class CraftingManager{
    ...
    private static final String quartzCrystals="EqECertusQuartz";
    ...
    public static void initRecipes(){
        ...
        if(!ConfigManager.useEE3){
            GameRegistry.addShapedRecipe(ItemEnum.EMCBOOK.getSizedStack(1)," D ","DBD"," D ",'D',dust,'B',Items.book);
        }
        initCellRecipies();
    }
    ...
    private static void initCrafterRecipies(){
        GameRegistry.addShapedRecipe(new ItemStack(BlockEnum.EMCCRAFTER.getBlock()),"CDC","DFD","CDC",'C',base,'D',dust,'F',new ItemStack(aeMaterial,1,43));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BlockEnum.EMCCRAFTER.getBlock(),1,1),"GGG","GRG","GGG",'R',new ItemStack(BlockEnum.EMCCRAFTER.getBlock()),'G',"gemDiamond"));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BlockEnum.EMCCRAFTER.getBlock(),1,2),"MMM","MRM","MMM",'R',new ItemStack(BlockEnum.EMCCRAFTER.getBlock(),1,1),'M',"gemEmerald"));
        GameRegistry.addShapedRecipe(new ItemStack(BlockEnum.EMCCRAFTER.getBlock(),1,3),"SSS","SRS","SSS",'R',new ItemStack(BlockEnum.EMCCRAFTER.getBlock(),1,2),'S',Items.nether_star);
    }
    private static void initCondenserRecipies(){
        GameRegistry.addShapedRecipe(new ItemStack(BlockEnum.EMCCONDENSER.getBlock()),"BDB","BAB","BDB",'B',base,'D',dust,'A',new ItemStack(aeMaterial,1,44));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BlockEnum.EMCCONDENSER.getBlock(),1,1),"DDD","DCD","DDD",'C',new ItemStack(BlockEnum.EMCCONDENSER.getBlock()),'D',"gemDiamond"));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BlockEnum.EMCCONDENSER.getBlock(),1,2),"EEE","ECE","EEE",'C',new ItemStack(BlockEnum.EMCCONDENSER.getBlock(),1,1),'E',"gemEmerald"));
        GameRegistry.addShapedRecipe(new ItemStack(BlockEnum.EMCCONDENSER.getBlock(),1,3),"NNN","NCN","NNN",'C',new ItemStack(BlockEnum.EMCCONDENSER.getBlock(),1,2),'N',Items.nether_star);
    }
}
