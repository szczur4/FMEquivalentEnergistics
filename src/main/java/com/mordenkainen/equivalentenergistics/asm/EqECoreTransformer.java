...
public class EqECoreTransformer implements IClassTransformer{
    private static final BiPredicate<AbstractInsnNode,Integer> standardTest=(n,i)->n.getOpcode()==i;
    private static final BiPredicate<AbstractInsnNode,Integer> forgetAllTest=(n,i)->n.getOpcode()==i&&((VarInsnNode)n).var==0;
    private static void applyPatch(final MethodNode methodNode,final int opcode,final BiPredicate<AbstractInsnNode,Integer> test,final boolean before,final String event){
        ...
        while(insnNodes.hasNext()&&!found){
            ...
            if(test.test(insn,opcode)){
                ...
                if(before)methodNode.instructions.insertBefore(insn,endList);
                else methodNode.instructions.insert(insn,endList);
            }
        }
    }
    @Override
    public byte[] transform(final String name,final String transformedName,final byte[] basicClass){
        if("com.pahimar.ee3.knowledge.PlayerKnowledgeRegistry".equals(name)){
            ...
            for(final MethodNode methodNode: classNode.methods)for(final patches patch: patches.values())if(methodNode.name.equals(patch.method)&&methodNode.desc.equals(patch.desc))applyPatch(methodNode,patch.opcode,patch.test,patch.before,patch.event);
    ...
    private enum patches{
        LEARN("teachPlayer","(Ljava/lang/String;Ljava/lang/Object;)V",Opcodes.INVOKEVIRTUAL,standardTest,true,"postPlayerLearn"),LEARNCOL("teachPlayer","(Ljava/lang/String;Ljava/util/Collection;)V",Opcodes.GOTO,standardTest,false,"postPlayerLearn"),FORGET("makePlayerForget","(Ljava/lang/String;Ljava/lang/Object;)V",Opcodes.INVOKEVIRTUAL,standardTest,true,"postPlayerForget"),FORGETCOL("makePlayerForget","(Ljava/lang/String;Ljava/util/Collection;)V",Opcodes.GOTO,standardTest,false,"postPlayerForget"),FORGETALL("makePlayerForgetAll","(Ljava/lang/String;)V",Opcodes.ALOAD,forgetAllTest,true,"postPlayerForget");
        public final String method;
        public final String desc;
        public final int opcode;
        public final BiPredicate<AbstractInsnNode,Integer> test;
