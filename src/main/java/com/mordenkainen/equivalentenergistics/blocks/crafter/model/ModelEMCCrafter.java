...
public final class ModelEMCCrafter extends ModelBase{
    ...
    public void render(){
        ...
        for(final float f1: new float[]{0.0F,1.5707963267948966F,3.141592653589793F})for(final float f2: new float[]{0.0F,1.5707963267948966F,3.141592653589793F,4.7123889803846898F}){
            setRotateAngle(frame,f1,f2,0.0F);
            frame.render(scale);
        }
        for(final float f1: new float[]{0.0F,1.5707963267948966F})for(final float f2: new float[]{0.0F,1.5707963267948966F,3.141592653589793F,4.7123889803846898F}){
