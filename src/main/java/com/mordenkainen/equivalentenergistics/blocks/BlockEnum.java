...
public enum BlockEnum{
    EMCCONDENSER("EMCCondenser",new BlockEMCCondenser(),ItemBlockMulti.class,Predicates.and(Integration.Mods.AE2.getTest(),Predicates.or(Integration.Mods.EE3.getTest(),Integration.Mods.PROJECTE.getTest())),"EMCCondenser",false),EMCCRAFTER("EMCCrafter",new BlockEMCCrafter(),ItemBlockMulti.class,Predicates.and(Integration.Mods.AE2.getTest(),Predicates.or(Integration.Mods.EE3.getTest(),Integration.Mods.PROJECTE.getTest())),"EMCCrafter",false);
